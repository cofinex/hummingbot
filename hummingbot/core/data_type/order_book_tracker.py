...
class OrderBookTracker:
    ...
    @property
    def ready(self) -> bool:
        # Fallback to the presence of initialized order books in case the event
        # has not been set yet (e.g., task cancellation between snapshot load and event set).
        return self._order_books_initialized.is_set() or len(self._order_books) > 0
    ...
    def start(self):
        ...
        self._order_book_snapshot_listener_task = task
